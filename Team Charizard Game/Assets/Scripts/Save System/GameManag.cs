...
public class GameManag : MonoBehaviour
{
    ...
    public void OnGameLoad(SaveData sd)
    {
        ...
        if (sd != null)
        {
            ...
            qualita = sd.qualita;
            risoluzione = sd.risoluzione;
            fullSchermo = sd.fullSchermo;
    ...
    private void EmptyArrays()
    {
        ...
        //for (int i = 0; i < seenRooms.Length; i++) { seenRooms = new bool[N_ROOMS]; /*nControl++;*/ }
    ...
    private void OnDestroy()
    {
        ...
        /*if(gameObject.scene.buildIndex == 0)*/ SaveDataAfterUpdate();
